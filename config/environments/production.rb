Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "insomniax_#{Rails.env}"
  ...
  config.action_mailer.smtp_settings = {
      :address   => "ocean.mxroute.com",
      :port      => 465, # ports 587 and 2525 are also supported with STARTTLS
      :enable_starttls_auto => true, # detects and uses STARTTLS
      :user_name => "insomnia",
      :password  => "S@eetbj1!", # SMTP password is any valid API key
      :authentication => 'login', # Mandrill supports 'plain' or 'login'
      :domain => 'insomniax.biz', # your domain to identify your server when connecting
    }

...
ActiveRecord::Schema.define(version: 20161112171310) do
  ...
  add_index "chatgroups", ["slug"], name: "index_chatgroups_on_slug", unique: true, using: :btree
  ...
  add_index "hearts", ["micropost_id"], name: "index_hearts_on_micropost_id", using: :btree
